...
const logos = [
    ...
    { name: "LiveKit", url: "https://identitydesigned.com/wp-content/uploads/2024/02/00-livekit-wordmark-01-scaled.jpg", size: "h-16 md:h-20" },
    { name: "Wordpress", url: "https://s.w.org/style/images/about/WordPress-logotype-standard-white.png", size: "h-10 md:h-14" },
];

const PartnerMarquee = () => {
    return (
        <div className="w-full relative overflow-hidden py-10 fade-mask">
