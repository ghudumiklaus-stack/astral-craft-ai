...
const Portfolio = () => {
  ...
  return (
    <section id="portfolio" className="relative py-24 pb-12 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {/* Alavanca Ads Card - Now standardized */}
          <div className="relative aspect-[4/3] rounded-3xl overflow-hidden group cursor-pointer">
            ...
            <div className="absolute inset-0 flex items-end p-6 group-hover:opacity-0 transition-opacity duration-300">
              <div>
                <h3 className="text-lg font-semibold text-white">Alavanca Ads</h3>
                <p className="text-sm text-white/80">UGC & Comerciais com IA</p>
              </div>
            </div>
          </div>
